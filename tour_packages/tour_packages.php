...
<head>
    ...
    <title>Tour Packages - Adventure Travel.lk</title>
...
<body>
    ...
    <section class="hero" style="background-image: url('../images/<?php echo htmlspecialchars($featured_package['image']); ?>');">
        ...
        <div class="hero-content">
            <h1>Explore Sri Lanka with Our Tour Packages</h1>
            <p>Experience the beauty, culture, and adventure on a multi-day tour</p>
            <a href="#tour-packages" class="btn">View Packages</a>
        </div>
    </section>
    <?php else: ?>
    ...
    <section id="sri-lanka-map-section" class="section">
        <div class="container">
            <div class="section-title">
                <h2>Explore Our Tour Locations</h2>
