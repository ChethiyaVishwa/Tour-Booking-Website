...
<head>
    ...
    <title>Special Tour Packages - Adventure Travel.lk</title>
...
<body>
    ...
    <section class="hero" style="background-image: url('../images/<?php echo htmlspecialchars($featured_package['image']); ?>');">
        ...
        <div class="hero-content">
            ...
            <p>Experience our unique, specially curated tours across Sri Lanka</p>
            <a href="#special-packages" class="btn">View Packages</a>
        </div>
    </section>
    <?php else: ?>
    <section class="hero" style="background-image: url('../images/tour-1.png');">
        <a href="../index.php" class="back-to-home">
            <i class="fas fa-arrow-left"></i> Back to Home
        </a>
        <div class="hero-content">
            <h1>Exclusive Special Tours</h1>
            <p>Unique experiences and luxury tours for special occasions</p>
    ...
    <section id="special-tours" class="section">
        <div class="container">
            <div class="section-title">
                <h2>Our Special Tour Packages</h2>
