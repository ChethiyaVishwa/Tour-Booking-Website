...
<head>
    ...
    <title>Terms and Conditions - Adventure Travel.lk</title>
    ...
    <section class="policy-section">
        <div class="container">
            <div class="policy-header">
                <h1><?php echo isset($policy['policy_title']) ? htmlspecialchars($policy['policy_title']) : 'Terms and Conditions'; ?></h1>
            </div>
